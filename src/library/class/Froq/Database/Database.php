...
use Froq\Database\Vendor\Factory\{Mysql, Couch, Mongo};
...
final class Database
{
    ...
    *
    * @param  string $vendor
    * @return Froq\Database\Vendor\Factory\{Mysql, Couch, Mongo}
    * @throws \Exception
    */
    ...
    *
    * @return Froq\Database\Vendor\Factory\Mysql
    */
    ...
    *
    * @return Froq\Database\Vendor\Factory\Couch
    */
    ...
    *
    * @return Froq\Database\Vendor\Factory\Mongo
    */
